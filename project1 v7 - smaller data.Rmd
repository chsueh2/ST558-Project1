...
<font color = red>
Note: I have to reduce the size of data set because I easily use up my API call quota with the original query list. I have save the previous work with full data set (790 of movie inquiries) and its EDA report: "project1 v6.Rmd" and "project1 v6.nb.html".

In this version, I have to reduce the size of the query. I will only sample some by adding `slice_sample()` to the following code chunk. Hopefully, the returned data have enough valid Batman and Superman movies that have been played in the theater for my EDA.
</font>
